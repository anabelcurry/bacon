...
Scenario('Search bacon', async ({ I }) => {
    ...
    // Search for "bacon"
    await generalSteps.verifyAndClick(googlePage.inputSearchBar);
    await I.fillField(googlePage.inputSearchBar, 'bacon');
    await generalSteps.verifyAndClick(googlePage.btnGoogleSearch);
